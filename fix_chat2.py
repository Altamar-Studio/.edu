...
# Buscamos la función simulateAiResponse desde su inicio hasta el fin de la función.
pattern = r"        function simulateAiResponse\(userText\) \{.*?\n        function scrollToBottom\(\) \{"
...
html = re.sub(pattern, new_fetch, html, flags=re.DOTALL)

with open("aprendizaje.html", "w", encoding="utf-8") as f:
    f.write(html)

print("aprendizaje.html patched with async function fetchAiResponse")
